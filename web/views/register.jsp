...
<div id="main_container">
    <form method="post">
        <p style="color: whitesmoke; font-family: Calibri; font-weight: bold">РЕГИСТРАЦИЯ</p>
        <input name="email" type="email" autofocus required placeholder="E-mail">
        <input name="password" type="password" required placeholder="Пароль">
        <input name="userName" type="text" required placeholder="Имя">
        <input id="submitbutton" type="submit" value="ОК">
    </form>
    <%
        if (sesssionUserId != null && sesssionUserId == -2) {
            out.println("<div style = \"display: block; width: 100%; align-content: center; text-align: center\" >");
            out.println("<P style = \"color: red; font-family: Calibri; font-weight: bold; margin-top: 0\" > ПОЛЬЗОВАТЕЛЬ УЖЕ ЗАРЕГИСТРИРОВАН</P >");
            out.println("</div >");
        }
    %>
</div>
